...
default_t	defaults[] =
{
    {"mouse_sensitivity",&mouseSensitivity,5,DTYP_INTEGER},
    ...
    {"key_up",&key_up, KEY_UPARROW,DTYP_INTEGER},
    {"key_down",&key_down, KEY_DOWNARROW,DTYP_INTEGER},
    {"key_strafeleft",&key_strafeleft, ',',DTYP_INTEGER},
    {"key_straferight",&key_straferight, '.',DTYP_INTEGER},

    {"key_fire",&key_fire, KEY_RCTRL,DTYP_INTEGER},
    {"key_use",&key_use, ' ',DTYP_INTEGER},
...
/* UNIX hack, to be removed. */
    ...
    {"nomouserun",&NoMouseRun,0,DTYP_INTEGER},
...
/*    {"snd_channels",&numChannels, 4},*/
	...
	{"c2p_routine",(int *)&c2p_routine,(int)"PROGDIR:DoomAttackSupport/c2p/c2p",DTYP_STRING},
