...
; set up register constants
		...
		lea	(BPLSIZE,a1),a2	; a2 -> plane1 (end of plane0)

; load up (otherwise) unused address registers with bitplane ptrs

		movea.l	a2,a3		; a3 -> plane1
		lea	(2*BPLSIZE,a1),a4	; a4 -> plane2
		lea	(2*BPLSIZE,a4),a5	; a5 -> plane4
		lea	(2*BPLSIZE,a5),a6	; a6 -> plane6
...
; d1 = ................ a5b5c5d5e5f5g5h5 ................ a7b7c7d7e7f7g7h7
		...
		move.b	d1,(BPLSIZE,a6)	; 12 plane 7
		swap	d1		;  4
		move.b	d1,(BPLSIZE,a5)	; 12 plane 5
...
; d3 = ................ a1b1c1d1e1f1g1h1 ................ a3b3c3d3e3f3g3h3
		...
		move.b	d3,(BPLSIZE,a4)	; 12 plane 3
		swap	d3		;  4
