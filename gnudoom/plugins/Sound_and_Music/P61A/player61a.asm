...
channels = 2	;amount of channels to be played
...
P61_mfade
	...
	move	(a0),d0
	move.w	P61_FadeTo(pc),d1
	cmp.w	d1,d0
	beq.s	.skip
	blt.s	.add
	subq.w	#2,d0
.add	addq.w	#1,d0
	subq.w	#1,P61_FadeCount-P61_Master(a0)
	bgt.s	.skip
	move.w	P61_FadeSpeed-P61_Master(a0),P61_FadeCount-P61_Master(a0)
	move.w	d0,(a0)
.skip	move	P61_temp0+P61_Shadow(pc),d1
	mulu	d0,d1
	lsr	#6,d1
	move	d1,$a8(a6)
...
P61_nextpattern
	...
	move.w	#-2,P61_E8-P61_cn(a3)		;songend
