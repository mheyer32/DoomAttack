...
;**************************************************************************
		...
		dc.l		InitChunky
		dc.l		EndChunky
		dc.l		C2PF_SIGNALFLIP | C2PF_VARIABLEHEIGHT | C2PF_VARIABLEWIDTH
...
InitChunky:
		...
		move.l	c2pi_FlipTask(a0),fliptask
		move.l	c2pi_FlipMask(a0),flipmask
		move.l	c2pi_DoomTask(a0),doomtask
		move.l	c2pi_DoomMask(a0),doommask
...
EndChunky:
		move.l	c2p_bufptrs(pc),d0
		beq.s	.exit
		
		move.l	d0,a1
		move.l	chipbufsize(pc),d0
